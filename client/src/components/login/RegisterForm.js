...
import { setCurrentUser, setToken } from "../../utils/storage-utils";
        ...
        <div className="signin-form-container">
            ...
            <form onSubmit={onFormSubmit}>
                ...
                <div className="field-container reg">
                    <input type="text" id="name-login" placeholder="Name" required style={error.name ? { border: "1px solid red" } : {}} onChange={e => {
                ...
                <div className="field-container reg">
                    <input type="email" id="email-login" placeholder="Email" style={error.email ? { border: "1px solid red" } : {}} required onChange={e => {
