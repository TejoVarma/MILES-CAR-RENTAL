...
import { addNewCar } from "../../utils/api-utils";
    ...
    function formValidation(e) {
        ...
        .then(res => {
            if(res.status === "Success") {
                ...
                setLoader(true);
                navigate("/admin/cars")
                toast.success(`Car has successfully added`, {
                ...
                <form onSubmit={formValidation}>
                    ...
                    <div className="buttons-container-admin">
                        <div className="field-container-admin flex-boxes-admin">
                            <button className="cancel-button-admin" onClick={()=> navigate('/admin/cars')}>Cancel</button>
                        </div>
                        <div className="field-container-admin flex-boxes-admin post-admin">
                            {loader? <button className="submit-button-admin" type={"submit"}>Post</button> : <h2>Data is being uploaded...please wait!</h2>}
                        </div>
                    </div>
                </form>
            </div>
